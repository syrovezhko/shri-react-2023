...
const MovieCard: FC<IMovieCard> = ({name, genre, year, grade, director, text, picture}) => {
  return (
    <div className={styles.card}>
      <Image className={styles.picture} src={picture} width={400} height={500} alt="Picture of the movie"/>
